...
if data.numNodes > 1 then
	...
	placement_node.on_place = function(itemstack, placer, pointed_thing) --Mostly taken from core.item_place_node
        ...
        for i=2,data.numNodes do
			...
			local def = minetest.registered_nodes[name .. i]
        ...
        for i=2,data.numNodes do
            ...
            meta = minetest.get_meta(child_pos)
		...
		-- Run callback
		if placement_node.after_place_node and not prevent_after_place then -- luacheck: ignore
			-- Deepcopy place_to and pointed_thing because callback can modify it
			local place_to_copy = {x=place_to.x, y=place_to.y, z=place_to.z}
			local pointed_thing_copy = copy_pointed_thing(pointed_thing) -- luacheck: ignore
    ...
    placement_node.on_destruct = function(pos)
        ...
        node_pos_list = minetest.deserialize(meta:get_string("child_nodes"))
